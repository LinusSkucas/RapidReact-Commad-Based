...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    new JoystickButton(controller, 1).whenHeld(new ShooterTeleop(shooter, indexer, vision, drive));
    ...
    new JoystickButton(controller, 5).whenHeld(CommandFactory.runIndexerCommand(indexer));
